...
public class BinaryTree<E> {
	...
	public BinaryTree<E> copyToDepth(int d){
		...
		BinaryTree<E> copy = new BinaryTree<E>(data);
	
		if(d == 0) 
			return(copy);
		if(hasLeft()) 
			copy.left = left.copyToDepth(d-1);
		if(hasRight()) 
			copy.right = right.copyToDepth(d-1);
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println(root.copyToDepth(0));
		System.out.println(root.copyToDepth(1));
		System.out.println(root.copyToDepth(2));
		System.out.println(root.copyToDepth(3));
		...
		// Smaller trees
		BinaryTree<String> t1 = parseNewick("((a,b)c,(d,f)e)g;");	
